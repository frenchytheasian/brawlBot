...
def calculate_trophy_loss(trophies):
    if trophies <= 500: return 0
    elif trophies <= 524: return trophies % 25
    else: return trophies % 25 + 1    
...
async def trophy_reset(ctx):
    ...
    for brawler in player_brawlers:
        ...
        print(f'{brawler["name"]}: {brawler["trophies"]}, Losing {trophy_loss} trophies')
